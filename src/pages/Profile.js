      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-1 rounded-3xl border-2 border-primary p-5 flex flex-col  items-center justify-center">
          <img
            ...
            alt="img"
          />
          <p className="font-CatamaranBold font-[24px] my-5">Customer Name</p>
          <Button value="Update Avatar" width={220} height={50} />
        </div>
        <div className="col-span-2 flex flex-col justify-center items-center border-2 border-secondary rounded-3xl p-3">
          <FormInput
